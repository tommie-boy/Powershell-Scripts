...
$result += 1 | select-object @{n='computerName';e={ "$($env:computername)" }}, `
                                ...
                                @{n='Secure Boot DBDefault Certificate PCA 2011';e={ if($dbdefaultCertUpdated -match 'Windows UEFI CA 2023') { 'Updated to Windows UEFI CA 2023' } elseif($dbdefaultCertUpdated -match 'Microsoft Windows Production PCA 2011') { 'Microsoft Windows Production PCA 2011' } else { "N/a" } }}, `
                                @{n='Secure Boot DBDefault Certificate CA 2011';e={ if($dbdefaultCertUpdated -match 'Windows UEFI CA 2023') { 'Updated to Windows UEFI CA 2023' } elseif($dbdefaultCertUpdated -match 'Microsoft Corporation UEFI CA 2011') { 'Microsoft Corporation UEFI CA 2011' } else { "N/a" } }}, `
                                @{n='Secure Boot DB Certificate PCA 2011';e={ if($dbCertUpdated -match 'Windows UEFI CA 2023') { 'Updated to Windows UEFI CA 2023' } elseif($dbCertUpdated -match 'Microsoft Windows Production PCA 2011') { 'Microsoft Windows Production PCA 2011' } else { "N/a" } }}, `
                                @{n='Secure Boot DB Certificate CA 2011';e={ if($dbCertUpdated -match 'Windows UEFI CA 2023') { 'Updated to Windows UEFI CA 2023' } elseif($dbCertUpdated -match 'Microsoft Corporation UEFI CA 2011') { 'Microsoft Corporation UEFI CA 2011' } else { "N/a" } }}, `
